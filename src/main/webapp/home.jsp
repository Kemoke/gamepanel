    ...
    <div class="container-fluid" class="">
        <div class="row">
            <div class="col-md-12">
                ...
                <p align="center">Intuitive and User Firendly</p>
        </div>
        </div>
        ...
        <div class="row" >
            ...
            <div class="col-md-6">
                ...
                <p style="page-break-after: always;"> A web-based application to setup, manage, and monitor various game server hosts.<br>
                    ...
                    <br>Facilitating the management of the servers by receiveing diagnostic information regarding the status of each instance.
                </p>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <h4 class="card-title"><a>Flexibility</a></h4>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <h4><a>User Friendly</a></h4>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
